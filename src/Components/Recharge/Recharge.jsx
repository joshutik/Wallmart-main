...
//         setFlashMessage("Please fill in all fields for crypto recharge.");
//         setFlashType("error");
//         return;
//       }
//       setShowQrModal(true);
...
//                         type="button"
//                         onClick={() => handleCopy(bankDetails.account)}
//                       >
//                         Copy
//                       </button>
//                     </p>
...
//             <div className="my-4 text-center">
//               <button
//                 className="rounded-pill py-2 w-75 border-0 draw-btn fw-bold text-light fs-5 my-5 position-relative"
//                 type="submit"
...
//                       className="rounded-pill py-2 px-3 border-0 fw-bold"
//                     >
//                       Copy
//                     </button>
//                   </div>
...
//                     <button
//                       type="button"
//                       onClick={() => handleCopy(bankDetails.recipient)}
//                       className="rounded-pill py-2 px-3 border-0 fw-bold"
//                     >
//                       Copy
//                     </button>
...
//                   <div className="text-center py-lg-5 py-4">
//                     <p>Amount</p>
//                     <p>{formatAmount(amountFromQuery)}</p>
//                     <div className="w-75 me-lg-auto mx-auto">
//                       <hr className="horizontal border-3 text-white " />
//                     </div>
//                     <button
...
//               <input
//                 type="text"
//                 className="form-control ps-5 py-4 border border-3 rounded-pill"
//                 value={senderName}
//                 onChange={(e) => setSenderName(e.target.value)}
//                 placeholder="Name"
//                 required
...
//       )}
//       {flashMessage && (
//         <div className={`alert ${flashType === "error" ? "alert-danger" : "alert-success"} text-center`} role="alert">
//           {flashMessage}
//         </div>
//       )}
//     </div>
