...
//   const handleGrabClick = () => {
//     if (grabAttempts < 3) {
//       if ((user_level === "VIP1" && orderCount < 3) || (user_level === "VIP3" && orderCount < 12)) {
//         setShowModal(true); // Show the payment modal
...
//       }
//     } else {
//       notifyTaskCompleted(); // Notify the user after 3 attempts
//     }
//   };
...
import { Circle } from 'rc-progress';
import Modal1 from '../Modal/Modal1';
import ModalTaskCompleted from '../Modal/ModalTaskCompleted'; // Import the new modal
import axios from 'axios';
import NavigationBar from '../NavigationBar/NavigationBar';
import NavigationBar2 from '../NavigationBar2/NavigationBar2';
