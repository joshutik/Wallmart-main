...
// const Usercomision = () => {
//   const cards = [
//     { img: slide1, text: "231***98465", commission: "$12.3" },
//     { img: slide2, text: "231***98465", commission: "$12.3" },
//     { img: slide3, text: "231***98465", commission: "$12.3" },
//     { img: slide4, text: "231***98465", commission: "$12.3" },
//     { img: slide1, text: "231***98465", commission: "$12.3" },
//   ];
...
//             <div key={index} className="card border-0 mx-3 rounded-5 w-25 py-5 px-2 fw-bold">
//               <div className="d-flex justify-content-around align-items-center">
...
//               <div className="d-flex justify-content-around align-items-center">
//                 <p className="my-3">Commission</p>
//                 <span className="btn rounded-5 comm fw-bold">{card.commission}</span>
//               </div>
//             </div>
//           ))}
//           {cards.map((card, index) => (
//             <div key={index + cards.length} className="card border-0 mx-3 rounded-5 w-25 py-5 px-2 fw-bold">
//               <div className="d-flex justify-content-around align-items-center">
//                 <img src={card.img} alt="" />
//                 <span>{card.text}</span>
//               </div>
